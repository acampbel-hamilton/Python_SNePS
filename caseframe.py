...
class CaseFrame:
    def __init__(self, name, _type, docstring="", slots=[], adj_to=set(), adj_from=set(), terms=set()):
        self.name = Sym(name)
        self.type = _type # must be either obj or class itself
        self.docstring = docstring
        self.slots = slots # list of slot names
        self.adj_to = adj_to
    ...
    def __eq__(self, other):
        ...
        return isinstance(other, CaseFrame) and self.type is other.type and len(set(self.slots) - set(other.slots)) == 0
